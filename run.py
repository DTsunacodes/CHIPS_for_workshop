...
def parse_command_line():
	parser = OptionParser(
		description = '''Execution script. The MESA calculation will be conducted by running the code with ZAMS mass/Z and inlist file as arguments, For example, to calculate an 1e51erg interaction-powered supernova from a ZAMS 15Msun, solar metallicity star having CSM generated by an eruption with tinj=10yrs, finj=0.5, run the following:\n
		python run.py --tinj 10 --finj 0.5 --Eej 1e51 --stellar-model input/mesa_models_rsg/15Msun_Z0.014_preccsn.data --analytical-CSM
		'''
	)
	...
	parser.add_option("--eruption-Ncell", metavar = "int", type = "int", default = 2000, help = "Number of cells in the eruption calculation (default: 2000).")
